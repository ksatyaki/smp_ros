...
int smp::ExtenderDubins::extend_dubins_spheres(
...
double smp::ExtenderDubins::extend_dubins_all(
    StateDubins *state_ini, StateDubins *state_fin, int *fully_extends,
...
smp::ExtenderDubins::ExtenderDubins() {}

smp::ExtenderDubins::~ExtenderDubins() {}

int smp::ExtenderDubins::extend(
