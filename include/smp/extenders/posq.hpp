...
//!  Control
/*!
      This class implements the state data structure. The number of state
      variables is three. The state variables indicate position in the x and y
      coordinates and the orientation, in this order.
