...
int smp::extender_pos<typeparams, NUM_DIMENSIONS>::ex_update_insert_vertex(
    vertex_t *vertex_in) {
...
template <class typeparams, int NUM_DIMENSIONS>
int smp::extender_pos<typeparams, NUM_DIMENSIONS>::ex_update_insert_edge(
    edge_t *edge_in) {
...
template <class typeparams, int NUM_DIMENSIONS>
int smp::extender_pos<typeparams, NUM_DIMENSIONS>::ex_update_delete_vertex(
    vertex_t *vertex_in) {
...
template <class typeparams, int NUM_DIMENSIONS>
int smp::extender_pos<typeparams, NUM_DIMENSIONS>::ex_update_delete_edge(
    edge_t *edge_in) {
...
template <class typeparams, int NUM_DIMENSIONS>
double
smp::extender_pos<typeparams, NUM_DIMENSIONS>::set_angle_to_range(double alpha,
                                                                  double min) {
...
template <class typeparams, int NUM_DIMENSIONS>
double smp::extender_pos<typeparams, NUM_DIMENSIONS>::diff_angle_unwrap(
...
template <class typeparams, int NUM_DIMENSIONS>
double smp::extender_pos<typeparams, NUM_DIMENSIONS>::normangle(double a,
                                                                double mina) {
...
template <class typeparams, int NUM_DIMENSIONS>
double smp::extender_pos<typeparams, NUM_DIMENSIONS>::f(double rho) {
...
template <class typeparams, int NUM_DIMENSIONS>
double *smp::extender_pos<typeparams, NUM_DIMENSIONS>::posctrlstep(
    double x_c, double y_c, double t_c, double x_end, double y_end,
    double t_end, double ct, double b, int dir) {
...
template <class typeparams, int NUM_DIMENSIONS>
double smp::extender_pos<typeparams, NUM_DIMENSIONS>::posctrl(
    state_t *state_ini, state_t *state_fin, int dir, double b, double dt,
...
template <class typeparams, int NUM_DIMENSIONS>
smp::extender_pos<typeparams, NUM_DIMENSIONS>::extender_pos() {
...
template <class typeparams, int NUM_DIMENSIONS>
int smp::extender_pos<typeparams, NUM_DIMENSIONS>::extend(
