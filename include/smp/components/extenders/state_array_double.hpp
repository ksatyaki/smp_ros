...
template <int NUM_STATES>
smp::state_array_double<NUM_STATES>::state_array_double(
    const smp::state_array_double<NUM_STATES> &state_in) {
...
template <int NUM_STATES>
const smp::state_array_double<NUM_STATES> &smp::state_array_double<NUM_STATES>::
...
template <int NUM_STATES>
double &smp::state_array_double<NUM_STATES>::operator[](int index_in) {
