...
using State = smp::StatePosQ;
using Input = smp::InputPosQ;
using Trajectory = smp::Trajectory<State, Input>;

namespace smp_ros {

class RRTStarPosQGlobalPlanner : public nav_core::BaseGlobalPlanner {

private:
  ros::NodeHandle nh;
  smp::samplers::Uniform<State, 3> sampler;
  smp::extenders::PosQ extender;
...
public:
  inline RRTStarPosQGlobalPlanner() {}
  inline virtual ~RRTStarPosQGlobalPlanner() {}
};
